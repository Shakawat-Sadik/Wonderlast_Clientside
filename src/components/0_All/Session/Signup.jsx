      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-10 lg:px-6">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <Logo
            ...
            aria-hidden={true} />
          <h3
            className="text-balance mt-2 text-center text-lg font-bold text-foreground dark:text-foreground">
        ...
        <Card className="mt-4 shadow-2xs sm:mx-auto sm:w-full sm:max-w-md">
          <CardContent>
            <form onSubmit={handleForm} method="post" className="space-y-4">
              ...
              <div>
                <Label
                  htmlFor="confirm-passwordSignup"
                  className="text-sm font-medium text-foreground dark:text-foreground">
                  Confirm password
                </Label>
                <Input
                  type="password"
                  id="confirm-passwordSignup"
                  name="confirm-passwordSignup"
                  autoComplete="confirm-passwordSignup"
                  placeholder="Password"
                  className="mt-2" />
              </div>
              ...
              <div className="mt-2 flex items-start">
                <div className="flex h-6 items-center">
                  <Checkbox id="newsletterSignup" name="newsletterSignup" className="size-4" />
                </div>
                <Label
              ...
              <p
                className="text-pretty text-center text-xs text-muted-foreground dark:text-muted-foreground">
        ...
        <p
          className="text-pretty mt-6 text-center text-sm text-muted-foreground dark:text-muted-foreground">
