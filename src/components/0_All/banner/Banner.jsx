...
const Banner = () => {
    return (
    <div className={`bg-foreground text-background flex justify-between flex-col items-center gap-5 h-150`}>
      <div className="p-10 text-center flex justify-center flex-col items-center gap-3.5 flex-1">
        ...
        <div className="flex gap-5">
          <button className="uppercase bg-primary px-5 py-3 cursor-pointer">
            Explore Now
          </button>

          <button className="uppercase px-5 py-3 bg-background/50 cursor-pointer">
            View Destination
          </button>
        </div>
      </div>

      <div className=" bg-background/30 flex justify-between gap-5 w-full items-center">
        <div className="px-3">
